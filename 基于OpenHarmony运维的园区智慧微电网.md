...
![图6-1 通过不同配比实现更高折叠比](/images/image.1.png "图6-1 通过不同配比实现更高折叠比")  ![图6-1 通过不同配比实现更高折叠比](/images/image.1.png "图6-1 通过不同配比实现更高折叠比")  ![图6-1 通过不同配比实现更高折叠比](/images/image.1.png "图6-1 通过不同配比实现更高折叠比")  ![图6-1 通过不同配比实现更高折叠比](/images/image.1.png "图6-1 通过不同配比实现更高折叠比")    
![图6-2 太阳能板实物设计图](/images/image.1.png "图6-2 太阳能板实物设计图")  
...
![图3-1 项目架构](/images/image.1.png "图3-1 项目架构")  ![图3-1 项目架构](/images/image.1.png "图3-1 项目架构")  ![图3-1 项目架构](/images/image.1.png "图3-1 项目架构")  
## 7.3 电量预测
基于深度学习构建电量预测模型，通过预测实时电量和长短期发电量为用户量身定制用电规划，减少能源损耗，提高发电效率，降低设备运维成本。  
![图3-1 项目架构](/images/image.1.png "图3-1 项目架构")  ![图3-1 项目架构](/images/image.1.png "图3-1 项目架构")  
## 7.4 用户用电行为分析
