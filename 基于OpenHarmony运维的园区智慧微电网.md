...
![图5-5 电量预测数据集及训练拟合程度](images/image.6.png "图5-5 电量预测数据集及训练拟合程度")  ![](images/image.7.png )  
...
![图5-7 用电习惯及不同方案规划](images/image.9.png "图5-7 用电习惯及不同方案规划")  ![](images/image.10.png )  
...
![图6-1 通过不同配比实现更高折叠比](images/image.11.1.png "图6-1 通过不同配比实现更高折叠比")  ![](images/image.11.2.png "")  ![](images/image.11.4.png)    
...
![图7-2 设备管理](images/image.26.jpg "图7-2 设备管理")  ![](images/image.26.2.jpg )  ![](images/image.26.3.jpg )  
## 7.3 电量预测
基于深度学习构建电量预测模型，通过预测实时电量和长短期发电量为用户量身定制用电规划，减少能源损耗，提高发电效率，降低设备运维成本。  
![图7-3 电量预测](images/image.27.1.jpg "图7-3 电量预测")  ![](images/image.27.2.jpg )  
## 7.4 用户用电行为分析
通过K-means聚类算法实现用户用电行为分析。收集用户的用电情况，通过大数据分析手段，及时、准确地掌握用户用电行为特征，并为用户进行等级划分，并根据不同等级来为用户提供不同的用电方案，实现电量的合理利用。  
![图7-4 页面设计](images/image.28.jpg "图7-4 页面设计")  
# 八、应用场景
## 8.1 工业园区
...
# 十、演示视频链接
[基于OpenHarmony运维的园区智慧微电网](https://www.bilibili.com/video/BV1iN4y1S7NM?vd_source=95fa07a4f0e2ce54c9d0e62c16338366)
